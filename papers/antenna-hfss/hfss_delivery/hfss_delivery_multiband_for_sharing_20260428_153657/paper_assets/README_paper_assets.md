...
Additional multiband results were generated for WLAN 2.4 GHz, 5G n78 and WLAN 5.8 GHz. The selected multiband HFSS design is `HFSSDesign_phone_multiband_enhanced`.

- `figures/fig_05_final_multiband_s11.png`: final multiband S11 across 1.5-6.5 GHz.
- `figures/fig_06_multiband_candidate_comparison.png`: candidate comparison by worst S11 in each band.
- `data/final_phone_multiband_S11.csv`: final multiband S11 data.
- `process/multiband_candidate_log.csv`: tested multiband candidates and band-by-band metrics.
