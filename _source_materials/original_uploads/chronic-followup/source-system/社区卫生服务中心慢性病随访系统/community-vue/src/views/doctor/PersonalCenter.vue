  ...
  <div class="personal-center">
    <el-card>
      ...
      <el-tabs v-model="activeTab" type="border-card">
        <el-tab-pane label="个人信息查看" name="view">
          <el-descriptions :column="2" border style="max-width: 800px; margin-top: 20px;">
            <el-descriptions-item label="用户名">{{ userInfo.username }}</el-descriptions-item>
            <el-descriptions-item label="姓名">{{ userInfo.name }}</el-descriptions-item>
            <el-descriptions-item label="角色">
              <el-tag :type="userInfo.role === 'admin' ? 'danger' : 'primary'">
                {{ userInfo.role === 'admin' ? '管理员' : userInfo.role === 'doctor' ? '医生' : userInfo.role }}
              </el-tag>
        ...
        <el-tab-pane label="个人信息修改" name="edit">
          <el-form
            ref="infoFormRef"
            :model="userInfo"
            :rules="infoRules"
